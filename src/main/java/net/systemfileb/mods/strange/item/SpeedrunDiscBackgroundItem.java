...
public class SpeedrunDiscBackgroundItem extends Item {
	public SpeedrunDiscBackgroundItem() {
		super(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON).food((new FoodProperties.Builder()).nutrition(10).saturationModifier(0.5f).alwaysEdible().build())
				...
				.jukeboxPlayable(ResourceKey.create(Registries.JUKEBOX_SONG, ResourceLocation.fromNamespaceAndPath(BucketStrangeMod.MODID, "speedrun_disc_background"))));
	}
