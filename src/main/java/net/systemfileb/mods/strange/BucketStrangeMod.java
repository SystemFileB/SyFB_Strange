package net.systemfileb.mods.strange;
...
@Mod("bucket_strange")
public class BucketStrangeMod {
	public static final Logger LOGGER = LogManager.getLogger(BucketStrangeMod.class);
	public static final String MODID = "bucket_strange";

	public BucketStrangeMod(IEventBus modEventBus) {
